					...
					if($result != null) {
						...
						switch($result){
							case 0:
								...
								$this->getServer()->broadcastMessage(TextFormat::DARK_PURPLE . "$player->getName() " . TextFormat::LIGHT_PURPLE . "transfered to " . TextFormat::AQUA . "OP factions");
							break;
							...
							case 1:
								...
								$this->getServer()->getCommandMap()->dispatch($sender, $command);
								$sender->sendMessage(TextFormat::RED . "Something went wrong - Contact server administrators if this was a mistake.");
									$this->getServer()->broadcastMessage(TextFormat::DARK_PURPLE . "$player->getName() " . TextFormat::LIGHT_PURPLE . "transfered to " . TextFormat::AQUA . "Normal factions");
						        break;
